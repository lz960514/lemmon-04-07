        ...
        <div class="main">
            <div class="c-login">
                <div class="login">
                    ...
                    <Button type="primary" @click="login" long size="large">登录</Button>
                </div>
            </div>
        </div>
    </Content>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      axios
        .post("/apis?action=login", this.userInfo)
        .then(({data}) => {
            if(data.code === 1) {
...
.main {
  ...
  height: 100%;
  background: #fff
    url(https://gtms04.alicdn.com/tps/i4/TB1vChNcXzqK1RjSZFoSuvfcXXa.jpg)
    no-repeat;
